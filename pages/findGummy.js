...
const FindGummy = () => {
  ...
  let zoomIn, zoomOut, goRight, goLeft, goUp, goDown, updateUI;
  ...
  useEffect(() => {
    ...
    zoomIn = () => scale *= 2;
    zoomOut = () => scale /= 2;
    goRight = () => offsetX += 1 / scale;
    goLeft = () => offsetX -= 1 / scale;
    goUp = () => offsetY -= 1 / scale;
    goDown = () => offsetY += 1 / scale;
        ...
        <div>
          <div className="max-w-md">
            <div className="grid grid-cols-6">
              ...
              <div></div>
              <div></div>
              <button className="btn-outline p-4" onClick={() => { goUp(); updateUI() }}>
            ...
            <div className="grid grid-cols-6">
              <button className="btn-outline p-4" onClick={() => { zoomIn(); updateUI() }}>
              ...
              <button className="btn-outline p-4" onClick={() => { zoomOut(); updateUI() }}>
                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <path
              ...
              <div></div>
              <button className="btn-outline p-4" onClick={() => { goLeft(); updateUI() }}>
                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  <path
                    d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" />
                </svg>
              </button>
              <button className="btn-outline p-4" onClick={() => { goDown(); updateUI() }}>
                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                  <path
                    d="M169.4 470.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 370.8 224 64c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 306.7L54.6 265.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" />
                </svg>
              </button>
              <button className="btn-outline p-4" onClick={() => { goRight(); updateUI() }}>
                <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                  <path
